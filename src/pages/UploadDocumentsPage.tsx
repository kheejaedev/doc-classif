...
const UploadDocumentsPage = ({ handleChangePage } : UploadDocumentsPageProps) => {
    ...
    return (
        <div>
            ...
            <div padding-top={2} style={{ display: 'flex', justifyContent: 'center', gap: '8px', marginTop: '16px' }}>
                <Button size="small" variant="contained" onClick={() => handleUpload()}>Submit</Button>
                <Button size="small" variant="outlined" onClick={() => goToListDocumentsPage()}>Cancel</Button>
            </div>
        </div>
    );
}
